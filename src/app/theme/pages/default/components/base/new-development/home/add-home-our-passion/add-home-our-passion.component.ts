...
@Component({
    selector: 'app-add-home-our-passion',
    templateUrl: './add-home-our-passion.component.html',
    encapsulation: ViewEncapsulation.None,
    styles: []
})
export class AddHomeOurPassionComponent implements OnInit {


    @ViewChild('alertImage', { read: ViewContainerRef }) alertBlog: ViewContainerRef;
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-add-home-our-passion',
    ...
    /**
     * Method to add ourpassion image
     */
    onSubmit() {
        ...
        this._brewery.addOurPassion(this.ourpassionForm.value, this.bname).subscribe(
            res => {
                if (res['status'] == true) {
