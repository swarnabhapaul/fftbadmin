...
@Component({
  selector: 'app-add-whychoose',
  templateUrl: './add-whychoose.component.html',
  encapsulation: ViewEncapsulation.None,
  styles: []
})
export class AddWhychooseComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this._admin.addWhyChoose(this.whychooseForm.value).subscribe(
      res => {
        if (res['status'] == true) {
