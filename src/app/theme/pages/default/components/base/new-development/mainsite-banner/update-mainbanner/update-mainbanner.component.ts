...
@Component({
    selector: 'app-update-mainbanner',
    templateUrl: './update-mainbanner.component.html',
    encapsulation: ViewEncapsulation.None,
    styles: []
})

export class UpdateMainbannerComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this._admin.getMainBannerById(this.getid).subscribe(
            res => {

                this.bannerData = res.data[0];
                this.besideLogo = 'http://api.fftb.co.uk/image/mainsitebanner2/' + this.bannerData.id;
                this.backgroundLogo = 'http://api.fftb.co.uk/image/mainsitebanner/' + this.bannerData.id;
                
                this.model.banner_backgound_image = this.bannerData.banner_backgound_image;
                this.model.banner_beside_image = this.bannerData.banner_beside_image;

                this.model.id = this.bannerData.id;

                this.model.banner_heading = this.bannerData.banner_heading;
                this.model.banner_description = this.bannerData.banner_description;

                $('#my-summernote').summernote('code', this.bannerData.banner_description);
            }, err => {
                console.log(err);
    ...
    onSubmit() {
        ...
        this._admin.updateMainBanner(this.mainbannerForm.value).subscribe(
            res => {
                if (res['status'] == true) {
